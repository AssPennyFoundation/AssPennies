...
static const int64 MAX_MONEY = 12012000 * COIN; // maximum number of coins (eight times the population of Nebraska)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        return dPriority > 100 * COIN * 120 / 250; // 120 blocks per day. Priority cutoff is 100 AssPennies per day / 250 bytes.
    }
