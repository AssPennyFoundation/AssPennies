...
// Copyright (c) 2014 AssPennies Developers - YOU THINK YOU'RE BETTER THAN ME?
...
const string strMessageMagic = "AssPennies Signed Message:\n";
...
// These functions dispatch to one or all registered wallets, or asses full of pennies.
...
static const int64 nTargetSpacing = 720; // 12 minute blocks (5 blocks per hour, 120 blocks per day)
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal asspennies miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AssPennies", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xea49f58ba662a38490722fe8c06adeb627366a81e2a1398d91fd124fb02085a0");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "you pick up my ass pennies for good luck";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        if (fTestNet)
        {
            block.nTime    = 1393731341;
            block.nNonce   = 1436297;
        }
